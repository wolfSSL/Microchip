                                ...
                                uint16_t* out_resp_size, void* resp_packet)
{
    ...
    switch (action) {
        ...
        case WH_MESSAGE_AUTH_ACTION_LOGIN: {
            ...
            rc = wh_MessageAuth_TranslateLoginRequest(magic, req_packet,
                                                      req_size, &req);
            if (rc != WH_ERROR_OK) {
                resp.rc = rc;
            }
                ...
                auth_data =
                    (uint8_t*)req_packet + sizeof(whMessageAuth_LoginRequest);
        ...
        case WH_MESSAGE_AUTH_ACTION_USER_ADD: {
            ...
            rc = wh_MessageAuth_TranslateUserAddRequest(magic, req_packet,
                                                        req_size, &req);
            if (rc != WH_ERROR_OK) {
                resp.rc = rc;
            }
                ...
                credentials =
                    (uint8_t*)req_packet + sizeof(whMessageAuth_UserAddRequest);
        ...
        case WH_MESSAGE_AUTH_ACTION_USER_SET_CREDENTIALS: {
            ...
            if (req_size < min_size) {
                ...
                if (rc != 0) {
                    ...
                    new_creds =
                        current_creds + req_header.current_credentials_len;
            ...
            if (current_creds != NULL &&
                req_header.current_credentials_len > 0) {
