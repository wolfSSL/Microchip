...
#endif /* !WOLFSSL_NO_VAR_ASSIGN_REG */
{
    ...
    "L_AES_ECB_encrypt_loop_block_256_%=:\n\t"
        ...
        "\n"
#if defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
    "L_AES_ECB_encrypt_block_nr_256:\n\t"
#else
...
#elif defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
        "BNE.W	L_AES_ECB_encrypt_block_nr_256\n\t"
#else
        "BNE.W	L_AES_ECB_encrypt_block_nr_256_%=\n\t"
#endif
        "UBFX	r8, r5, #16, #8\n\t"
        "LSR	r11, r4, #24\n\t"
        "UBFX	lr, r6, #8, #8\n\t"
...
#elif defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
        "BNE.W	L_AES_ECB_encrypt_block_nr_128\n\t"
#else
        "BNE.W	L_AES_ECB_encrypt_block_nr_128_%=\n\t"
#endif
        "UBFX	r8, r5, #16, #8\n\t"
        "LSR	r11, r4, #24\n\t"
        "UBFX	lr, r6, #8, #8\n\t"
...
#elif defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
        "BNE.W	L_AES_CBC_encrypt_block_nr_256\n\t"
#else
...
#elif defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
        "BNE.W	L_AES_CBC_encrypt_block_nr_128\n\t"
#else
        "BNE.W	L_AES_CBC_encrypt_block_nr_128_%=\n\t"
#endif
        "UBFX	r8, r5, #16, #8\n\t"
        "LSR	r11, r4, #24\n\t"
        "UBFX	lr, r6, #8, #8\n\t"
...
#endif /* !WOLFSSL_NO_VAR_ASSIGN_REG */
{
    ...
    "L_AES_CTR_encrypt_loop_block_256_%=:\n\t"
        ...
        "\n"
#if defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
    "L_AES_CTR_encrypt_block_nr_256:\n\t"
#else
    ...
    "L_AES_CTR_encrypt_loop_block_192_%=:\n\t"
        ...
        "\n"
#if defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
    "L_AES_CTR_encrypt_block_nr_192:\n\t"
#else
...
#elif defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
        "BNE.W	L_AES_CTR_encrypt_block_nr_192\n\t"
#else
        "BNE.W	L_AES_CTR_encrypt_block_nr_192_%=\n\t"
#endif
        "UBFX	r8, r5, #16, #8\n\t"
        "LSR	r11, r4, #24\n\t"
        "UBFX	lr, r6, #8, #8\n\t"
...
#elif defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
        "BNE.W	L_AES_CTR_encrypt_block_nr_128\n\t"
#else
        "BNE.W	L_AES_CTR_encrypt_block_nr_128_%=\n\t"
#endif
        "UBFX	r8, r5, #16, #8\n\t"
        "LSR	r11, r4, #24\n\t"
        "UBFX	lr, r6, #8, #8\n\t"
...
#endif /* !WOLFSSL_NO_VAR_ASSIGN_REG */
{
    ...
    "L_AES_ECB_decrypt_loop_block_256_%=:\n\t"
        ...
        "\n"
#if defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
    "L_AES_ECB_decrypt_block_nr_256:\n\t"
#else
...
#elif defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
        "BNE.W	L_AES_ECB_decrypt_block_nr_256\n\t"
#else
        "BNE.W	L_AES_ECB_decrypt_block_nr_256_%=\n\t"
#endif
        "UBFX	r8, r7, #16, #8\n\t"
        "LSR	r11, r4, #24\n\t"
        "UBFX	r12, r6, #8, #8\n\t"
    ...
    "L_AES_ECB_decrypt_loop_block_192_%=:\n\t"
        ...
        "\n"
#if defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
    "L_AES_ECB_decrypt_block_nr_192:\n\t"
#else
...
#elif defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
        "BNE.W	L_AES_ECB_decrypt_block_nr_192\n\t"
#else
        "BNE.W	L_AES_ECB_decrypt_block_nr_192_%=\n\t"
#endif
        "UBFX	r8, r7, #16, #8\n\t"
        "LSR	r11, r4, #24\n\t"
        "UBFX	r12, r6, #8, #8\n\t"
    ...
    "L_AES_ECB_decrypt_loop_block_128_%=:\n\t"
        ...
        "\n"
#if defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
    "L_AES_ECB_decrypt_block_nr_128:\n\t"
#else
...
#elif defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
        "BNE.W	L_AES_ECB_decrypt_block_nr_128\n\t"
#else
        "BNE.W	L_AES_ECB_decrypt_block_nr_128_%=\n\t"
#endif
        "UBFX	r8, r7, #16, #8\n\t"
        "LSR	r11, r4, #24\n\t"
        "UBFX	r12, r6, #8, #8\n\t"
...
#endif /* !WOLFSSL_NO_VAR_ASSIGN_REG */
{
    ...
    "L_AES_CBC_decrypt_loop_block_256_%=:\n\t"
        ...
        "\n"
#if defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
    "L_AES_CBC_decrypt_block_nr_256_odd:\n\t"
#else
    "L_AES_CBC_decrypt_block_nr_256_odd_%=:\n\t"
...
#elif defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
        "BNE.W	L_AES_CBC_decrypt_block_nr_256_odd\n\t"
#else
        "BNE.W	L_AES_CBC_decrypt_block_nr_256_odd_%=\n\t"
#endif
        "UBFX	r8, r7, #16, #8\n\t"
        "LSR	r11, r4, #24\n\t"
        "UBFX	r12, r6, #8, #8\n\t"
        ...
        "\n"
#if defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
    "L_AES_CBC_decrypt_block_nr_256_even:\n\t"
#else
...
#elif defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
        "BNE.W	L_AES_CBC_decrypt_block_nr_256_even\n\t"
#else
        "BNE.W	L_AES_CBC_decrypt_block_nr_256_even_%=\n\t"
#endif
        "UBFX	r8, r7, #16, #8\n\t"
        "LSR	r11, r4, #24\n\t"
        "UBFX	r12, r6, #8, #8\n\t"
    ...
    "L_AES_CBC_decrypt_loop_block_192_%=:\n\t"
        ...
        "\n"
#if defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
    "L_AES_CBC_decrypt_block_nr_192_odd:\n\t"
#else
...
#elif defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
        "BNE.W	L_AES_CBC_decrypt_block_nr_192_odd\n\t"
#else
        "BNE.W	L_AES_CBC_decrypt_block_nr_192_odd_%=\n\t"
#endif
        "UBFX	r8, r7, #16, #8\n\t"
        "LSR	r11, r4, #24\n\t"
        "UBFX	r12, r6, #8, #8\n\t"
...
#elif defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
        "BNE.W	L_AES_CBC_decrypt_block_nr_192_even\n\t"
#else
        "BNE.W	L_AES_CBC_decrypt_block_nr_192_even_%=\n\t"
#endif
        "UBFX	r8, r7, #16, #8\n\t"
        "LSR	r11, r4, #24\n\t"
        "UBFX	r12, r6, #8, #8\n\t"
    ...
    "L_AES_CBC_decrypt_loop_block_128_%=:\n\t"
        ...
        "\n"
#if defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
    "L_AES_CBC_decrypt_block_nr_128_odd:\n\t"
#else
    "L_AES_CBC_decrypt_block_nr_128_odd_%=:\n\t"
...
#elif defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
        "BNE.W	L_AES_CBC_decrypt_block_nr_128_odd\n\t"
#else
        "BNE.W	L_AES_CBC_decrypt_block_nr_128_odd_%=\n\t"
#endif
        "UBFX	r8, r7, #16, #8\n\t"
        "LSR	r11, r4, #24\n\t"
        "UBFX	r12, r6, #8, #8\n\t"
        ...
        "\n"
#if defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
    "L_AES_CBC_decrypt_block_nr_128_even:\n\t"
#else
...
#else
        "BNE.W	L_AES_CBC_decrypt_block_nr_128_even_%=\n\t"
#endif
        "UBFX	r8, r7, #16, #8\n\t"
        "LSR	r11, r4, #24\n\t"
        "UBFX	r12, r6, #8, #8\n\t"
...
#endif /* !WOLFSSL_NO_VAR_ASSIGN_REG */
{
    ...
    "L_AES_GCM_encrypt_loop_block_256_%=:\n\t"
        ...
        "\n"
#if defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
    "L_AES_GCM_encrypt_block_nr_256:\n\t"
#else
    ...
    "L_AES_GCM_encrypt_loop_block_192_%=:\n\t"
        ...
        "\n"
#if defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
    "L_AES_GCM_encrypt_block_nr_192:\n\t"
#else
    ...
    "L_AES_GCM_encrypt_loop_block_128_%=:\n\t"
        ...
        "\n"
#if defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
    "L_AES_GCM_encrypt_block_nr_128:\n\t"
#else
...
#elif defined(__IAR_SYSTEMS_ICC__) && (__VER__ < 9000000)
        "BNE.W	L_AES_GCM_encrypt_block_nr_128\n\t"
#else
        "BNE.W	L_AES_GCM_encrypt_block_nr_128_%=\n\t"
#endif
        "UBFX	r8, r5, #16, #8\n\t"
        "LSR	r11, r4, #24\n\t"
        "UBFX	lr, r6, #8, #8\n\t"
